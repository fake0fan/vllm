...
class OpenAIServingRender:
    ...
    def _extract_mm_features(
        ...
        mm_hashes: MultiModalHashes = engine_input[  # type: ignore[typeddict-item]
            "mm_hashes"
        ]
        raw_placeholders: MultiModalPlaceholders
        raw_placeholders = engine_input[  # type: ignore[typeddict-item]
            "mm_placeholders"
        ]
