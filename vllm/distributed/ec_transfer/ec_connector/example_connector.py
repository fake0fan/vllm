...
class ECExampleConnector(ECConnectorBase):
    ...
    def build_connector_meta(
        ...
        Example connector simplified implementation: only handles loading requests.

        Args:
            scheduler_output (SchedulerOutput): the scheduler output object.
            encoder_cache_manager (EncoderCacheManager, optional): not used in
                example connector.
        """
        meta = ECExampleConnectorMetadata()

        # Add items that need to be loaded from external storage
